...
## Major Cloud Providers
  ...
  * [Zoho](https://www.zoho.com) — Started as an e-mail provider but now provides a suite of services, some of which have free plans. List of services having free plans :
    * Catalyst by Zoho(https://catalyst.zoho.com/) - Full Stack cloud development platform with 180-day free trial with free tire renewed every month forever -Frontend to backend all features available in one platform
